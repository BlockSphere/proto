...
const (
	ActuatorService_TriggerAction_FullMethodName = "/actuator.ActuatorService/TriggerAction"
)
...
type ActuatorServiceClient interface {
	TriggerAction(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (*TriggerResponse, error)
}
...
func (c *actuatorServiceClient) TriggerAction(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (*TriggerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TriggerResponse)
	err := c.cc.Invoke(ctx, ActuatorService_TriggerAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActuatorServiceServer interface {
	TriggerAction(context.Context, *TriggerRequest) (*TriggerResponse, error)
...
func (UnimplementedActuatorServiceServer) TriggerAction(context.Context, *TriggerRequest) (*TriggerResponse, error) {
...
func _ActuatorService_TriggerAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActuatorServiceServer).TriggerAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActuatorService_TriggerAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActuatorServiceServer).TriggerAction(ctx, req.(*TriggerRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ActuatorService_TriggerAction_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/actuator.proto",
}
